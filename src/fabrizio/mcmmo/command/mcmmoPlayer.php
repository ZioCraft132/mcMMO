...
class mcmmoPlayer {
    ...
    public function __construct(mcMMO $plugin, CommandSender $sender, array $args) {
        ...
        if(!$sender->hasPermission("mcmmo.command.mcmmo") || !$sender->hasPermission("mcmmo.command.*")){
        ...
        switch($args[0]){
            case "help":
            case "?":
                if(!$sender->hasPermission("mcmmo.command.help") || !$sender->hasPermission("mcmmo.command.*")){
            ...
            case "profile":
                ...
                if(!$sender->hasPermission("mcmmo.command.profile.player") || !$sender->hasPermission("mcmmo.command.*")){
                    $sender->sendMessage("$prefix §cYou don't have permission to use this command.");
                    return true;
                }
            ...
            break;
            case "skills":
                if(!$sender->hasPermission("mcmmo.command.addlevel") || !$sender->hasPermission("mcmmo.command.*")){
                    $sender->sendMessage("$prefix §cYou don't have permission to use this command.");
                    return true;
                }
            ...
            break;
            case "reducelevel":
                if(!$sender->hasPermission("mcmmo.command.reducelevel") || !$sender->hasPermission("mcmmo.command.*")){
                    $sender->sendMessage("$prefix §cYou don't have permission to use this command.");
                    return true;
                }
                if(!isset($args[1])){
            ...
            break; 
            case "addxp":
                if(!$sender->hasPermission("mcmmo.command.addxp") || !$sender->hasPermission("mcmmo.command.*")){
                    $sender->sendMessage("$prefix §cYou don't have permission to use this command.");
                    return true;
                }
                if(!isset($args[1])){
            ...
            break;
            case "reducexp":
                if(!$sender->hasPermission("mcmmo.command.reducexp") || !$sender->hasPermission("mcmmo.command.*")){
                    $sender->sendMessage("$prefix §cYou don't have permission to use this command.");
                    return true;
                }
                if(!isset($args[1])){
