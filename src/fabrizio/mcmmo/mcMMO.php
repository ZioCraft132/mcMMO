...
use fabrizio\mcmmo\mcMMOManager;
...
class mcMMO extends PluginBase {
    ...
    public function onEnable() : void {
        ...
        $this->saveResource("backup/readme.md");
    ...
    public function getmcMMOManager() : mcMMOManager {
        return new mcMMOManager($this);
    }
     ...
     */ # This is for next update! Stay Tune.
